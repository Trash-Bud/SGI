...
export class MyKeyframeAnimation extends MyAnimation{
    ...
    update(t) {
        ...
        for (let compCounter = 0; compCounter < this.components.length; compCounter++){
            
            this.components[compCounter]["display"] = true;
            var replaceAnimationTransformations = []
            var animationsTransformations = this.components[compCounter]["animationTransformations"];
            ...
            this.components[compCounter]["animationTransformations"] = replaceAnimationTransformations;
